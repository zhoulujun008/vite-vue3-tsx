...
// size: number, decimals?: DecimalCount, scaledDecimals?: DecimalCount): FormattedValue {
//   if (size === null) {
//     return { text: '' };
//   }
...
//   return (
//   value: number, decimals: DecimalCount, scaledDecimals: DecimalCount, timeZone?: TimeZone): FormattedValue => {
//     if (todayPattern) {
